...
var B_Plus_Tree = (nodeCapacity) =>{
    ...
    // create new root
    var createNewRoot = (nodeLeft, nodeRight, key) => {
    ...
    var insertToParent = (parentNode, newChildNode, newChildFirstKey, newChildIndex) => {
        //
        // insert child info:
    ...
    var mergeLeaves = (leafLeft, leafRight) => { // merge (left + right) -> left
        //
        // add right to left:
    ...
    var mergeNode = (node) => { // merge the node with sibling
    ...
    var mergeNodes = (nodeLeft, nodeRight, nodeRightIndex) => { // merge (left + right) -> left
    ...
    var p_FindFirst = (key, value, isPrefixSearch) => {
    ...
    var p_FindLast = (key, value, isPrefixSearch) => {
        var findInfo = new FindInfo(key, value, isPrefixSearch);
        //
        if (findInfo.isKeyPresent) {
    ...
    var p_get_keys_by_prefix = (prefix) => {
        var res = [];
        var findInfo = m_public.findFirstPrefix(prefix);
        while (findInfo != null) {
    ...
    var rotateAmongNodesToLeft = (leftNode, rightNode) => {
    ...
    var rotateAmongNodesToRight = (leftNode, rightNode) => {
    ...
    var rotateAmongLeavesToLeft = (leftLeaf, rightLeaf) => {
    ...
    var rotateAmongLeavesToRight = (leftLeaf, rightLeaf) => {
    ...
    var searchLastLeaf = (key) => {
        //
        var doSearchLastLeaf = (node, key) => {
    ...
    var searchLastLeafByPrefix = (prefix) => {
        //
        var doSearchLastLeafByPrefix = (node, prefix) => {
    ...
    var searchLastLeafValue = (key, value) => {
        // search the key:
